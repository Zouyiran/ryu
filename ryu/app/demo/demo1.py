...
class NetworkAware(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    _NAME = 'network_aware'

    def __init__(self, *args, **kwargs):
        super(NetworkAware, self).__init__(*args, **kwargs)

        self.name = "NetworkAware"
    ...
    def switch_features_handler(self, ev):
        '''
         the path finder is triggered using the EventOFPSwitchFeature event
         the path: proactively finds the maximal disjoint paths between two switches
         and stores the results into the path table
        :param ev:
        :return:
        '''
        msg = ev.msg
    ...
    def add_flow(self, datapath, priority, match, actions, idle_timeout=0, hard_timeout=0):
        ...
        # about OFPFlowMod class, its __init__ method is like this:
